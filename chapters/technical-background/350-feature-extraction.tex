...
\todo[inline,color=red]{Basic Features - Scikit Image References}
...
\todo[inline,color=red]{Raw Moments - Scikit Image References}
...
\todo[inline,color=red]{Normalised Central Moments - Scikit Image References}

\subsection{Downsampled Image}
\todo[inline,color=red]{Techniques - Features: Downsampled Image}
