...
\begin{figure}[h!]
  ...
  \subfigure[4 Neighbour Regions]{
    \input{gfx/technical-background/connected-component/neighbour-4.tikz}
    \label{fig:4-neighbour-regions}
  }
  \quad
  \subfigure[4 Neighbour Connected]{
    \input{gfx/technical-background/connected-component/neighbour-4-connected.tikz}
    \label{fig:4-neighbour-connected}
  }\\
  \subfigure[8 Neighbour Regions]{
    \input{gfx/technical-background/connected-component/neighbour-8.tikz}
    \label{fig:8-neighbour-regions}
  }
  \quad
  \subfigure[8 Neighbour Connected]{
    \input{gfx/technical-background/connected-component/neighbour-8-connected.tikz}
...
\input{chapters/technical-background/recursive-algo}
...
\begin{figure}[h!]
  \centering
  \input{gfx/technical-background/connected-component/pixel-scan.tikz}
...
\input{chapters/technical-background/two-pass-algo}

\begin{figure}[h!]
  \centering

  \subfigure[Initial Image]{\input{gfx/technical-background/connected-component/iterative-pass-0.tikz}}\\
  \subfigure[After First Pass (Row 1)]{\input{gfx/technical-background/connected-component/iterative-pass-1.tikz}}\quad
  \subfigure[After First Pass (Row 2)]{\input{gfx/technical-background/connected-component/iterative-pass-2.tikz}}\quad
  \subfigure[After First Pass (Row 3)]{\input{gfx/technical-background/connected-component/iterative-pass-3.tikz}}\\
  \subfigure[After Second Pass]{\input{gfx/technical-background/connected-component/iterative-pass-4.tikz}}
