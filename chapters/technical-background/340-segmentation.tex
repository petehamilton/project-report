...
\begin{figure}[h!]
  ...
  \subcaption[Initial Image]{\input{gfx/background-omr/connected-component/iterative-pass-0.tikz}}
  
  \subcaption[1\textsuperscript{st} pass (Row 1)]{\input{gfx/background-omr/connected-component/iterative-pass-1.tikz}}
  
  \subcaption[1\textsuperscript{st} pass (Row 2)]{\input{gfx/background-omr/connected-component/iterative-pass-2.tikz}}
  
  \subcaption[1\textsuperscript{st} pass (Row 3)]{\input{gfx/background-omr/connected-component/iterative-pass-3.tikz}}
  
  \subcaption[2\textsuperscript{nd} Pass]{\input{gfx/background-omr/connected-component/iterative-pass-4.tikz}}
