...
\usepackage[dvipsnames]{xcolor}              % Colour Constants
...
\usepackage[capitalise,noabbrev]{cleveref}            % Clever Referencing
\usepackage{caption, subcaption}                      % For subfigures and captions
